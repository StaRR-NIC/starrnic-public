...
add_files -norecurse -scan_for_includes axi_stream_size_counter_rm_counter5.sv axi_lite_register_rm_counter5.sv pkt_size_counter5.sv -of_objects [get_reconfig_modules pkt_size_counter5]
